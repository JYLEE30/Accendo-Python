...
def main():
    ...
    if num_files:
        ...
        try:
            ...
            prompt = """
                (1) Retrieve key information from the "competencies" section:
                    - Report details (Type, Project Name, Level)
                    - Candidate info (ID, Email, Name)
                ...
                (2) Role and definition:
                    ...
                    - Always use sten, exclude sten5 or sten9.
                    - sten is a score scale from 1 to 10, sten 1 to 3 is consider as low, sten 4 to 7 is consider as moderate, and sten 8 to 10 is consider as high.
                    - Do not use (Name), keep every summary very concise and short, remove filler words like "a" or "the". Example: instead of "The candidate values transparency and open communication" write "Values transparency and open communication".
                
                (3) Leadership competency:
                    - Critique sub-competencies' descriptions, sten, implications, and tips.
                    - For each sub-competency, provide 2-3 bullet-point concise summary, prioritize bullet-points by relevance.
                
                (4) Agility competency:
                    A. Learning Agility: Critique description, sten, implications, and tips.
                        - Bullet-point 1 explaining how willing candidate is to learn.
                        - Bullet-point 2 explaining the first bullet-point considering the sten level.
                    B. Cognitive Ability: Critique the key insights of the sub-components (Inductive-Logical, Numerical, Verbal Reasoning).
                        - Bullet-point 1 explain the summary.
                        - Bullet-point 2 explain what it means for learning speed.
                
                (5) Cultural Fit competency:
                    - Critique sub-competencies' descriptions and sten.
                    - For each sub-competency, provide 2 bullet-point concise summary, prioritize bullet-points by relevance.
                    - The summary should describe how well the candidate's behaviour will fit into the working environment.
                
                (6) Retrieve context from the "competencies" section:
                    A. List 3 sub_competencies with highest "score": {"sten"} as strength
                    B. Derailers: 
                        - lowest 2 "sub_competency" with "score": {"sten"} lower than 4
                        - highest 1 "sub_competency" with "score": {"sten"} higher than 7
                        - If no competency meet the two conditions, mention "No derailer".
                    C. CBI Questions: 3 questions from Leadership's sub-competencies, 2 based on competency with lowest sten and 1 based on highest sten. Try addressing several competencies in one question if the scores are the same.
                    D. Onboarding Plan: 3 strategies based on Learning Agility and Cognitive Ability score's level.

                (7) Format response as following sequence (do not add section headers).
                    ...
                    Strengths:
                    - {Strength 1}: {Brief description of why this is a strength}
                    - {Strength 2}: {Brief description of why this is a strength}
                    - {Strength 3}: {Brief description of why this is a strength}

                    Derailers:
                    - {Derailer 1}: {Brief description of why this sub-competency is a potential risk or challenge}
                    - {Derailer 2}: {Brief description of why this sub-competency is a potential risk or challenge}
                    - {Derailer 3}: {Brief description of why this sub-competency is a potential risk or challenge}

                    CBI Questions:
                    - {Sub-competency addressed 1}: {CBI Question 1}
                    - {Sub-competency addressed 2}: {CBI Question 2}
                    - {Sub-competency addressed 3}: {CBI Question 3}
                    ...
                    + {Agility's sub-competency 1's name}: {Agility's sub-competency 1's sten}
                        - {Agility's sub-competency 1's bullet point 1}
                        - {Agility's sub-competency 1's bullet point 2}
                    Continue... 
                    ...
                    + {Cultural Fit's sub-competency 1's name}: {Cultural Fit's sub-competency 1's sten}
                        ...
                        - {Cultural Fit's sub-competency 2's bullet point 1}
                    Continue... 
            """
