...
def save_text_as_pdf(text, output_path):
    ...
    pdf.multi_cell(0, 5, txt=text)  # cell_width set to 0 to use the full page width (within margins)
...
def main():
    ...
    output_path = rf'C:\Users\leeji\OneDrive\Desktop\Accendo Projects\Executive Report\ExecRep AI-04 Ollaman_Meta_Llama3-8B_M1_{timestamp}.pdf'
